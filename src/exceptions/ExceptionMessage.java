...
/**
 * Class that will display an error message in case of exceptions and close the
...
public class ExceptionMessage {
	...
	public void showError(Exception e, String userMessage) {
		...
		// Faced with an error, I prefer to close the program so the user cannot use the
		// application until it has been fixed.
		System.exit(1);
	}
}
...
public class GestionUI extends JFrame {
	...
	private ClientUI formularioCliente;
	private ClientEditUI formularioClienteEditar;
	private GameUI formularioJuego;
	private GameUpdateUI formularioJuegoEditar;
	 ...
	 * @param controlador2 
	 */
	public GestionUI(HomeUI menu, Model modelo, Controller controlador, Validator validador) {
		setResizable(false);
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				reiniciarBotones();
				controlador.cambiarVentana(GestionUI.this, menu);
		...
		btnAnadircliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (formularioCliente == null) {
					formularioCliente  = new ClientUI(GestionUI.this, controlador, modelo, validador);
				}
				
				controlador.cambiarVentana(GestionUI.this, formularioCliente);
				reiniciarBotones();
			}
		});		
		...
		btnEditarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (formularioClienteEditar == null) {
					formularioClienteEditar = new ClientEditUI(GestionUI.this, controlador, modelo, validador);
				}
				...
				controlador.cambiarVentana(GestionUI.this, formularioClienteEditar);
				reiniciarBotones();
			}
		});
		...
		btnAnadirJuego.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (formularioJuego == null) {
					formularioJuego  = new GameUI(GestionUI.this, controlador, modelo, validador);
				}
				
				controlador.cambiarVentana(GestionUI.this, formularioJuego);
				reiniciarBotones();
			}
		});		
		...
		btnEditarJuego.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (formularioJuegoEditar == null) {
					formularioJuegoEditar = new GameUpdateUI(GestionUI.this, controlador, modelo, validador);
				}
				...
				controlador.cambiarVentana(GestionUI.this, formularioJuegoEditar);
				reiniciarBotones();
			}
		});

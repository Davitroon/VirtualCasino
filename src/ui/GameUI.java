...
public class GameUI extends JFrame {
	 ...
	 * @since 3.0
	 */
	public GameUI(GestionUI gestion, Controller controlador, Model modelo, Validator validador) {
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				limpiarCampos();
				controlador.cambiarVentana(GameUI.this, gestion);
			}
		});
		...
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				if (tipo.equalsIgnoreCase("SlotMachine")) {
					Slotmachine tragaperras = new Slotmachine(dinero);

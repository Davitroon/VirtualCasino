...
public class ClientEditUI extends JFrame {
	 ...
	 * @param gestion2 
	 */
	public ClientEditUI(GestionUI gestion, Controller controlador, Model modelo, Validator validador) {
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				modelo.modificarCliente(new Client (nombre, edad, genero, saldo, id, activo));
				
				limpiarCampos();
				controlador.cambiarVentana(ClientEditUI.this, gestion);
			}
		});		

...
public class ProfileUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ProfileUI(HomeUI menu, Controller controlador, Model modelo) {
		setResizable(false);
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambiarVentana(ProfileUI.this, menu);
			}
		});		
		...
		btnCerrarSesion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambiarVentana(ProfileUI.this, menu.getConectarse());

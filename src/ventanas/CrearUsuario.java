...
public class CrearUsuario extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CrearUsuario(Modelo modelo, Controlador controlador, Sesion sesion, Conectarse login, Validador validador) {
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				reiniciarContenido();
				controlador.cambiarVentana(CrearUsuario.this, login);
			}
		});	
